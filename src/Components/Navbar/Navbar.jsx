...
const Navbar = () => {
  ...
  useEffect(() => {
    const handleClickOutside = (event) => {
      if (modelosDropdownRef.current && !modelosDropdownRef.current.contains(event.target)) {
        setShowModelosDropdown(false);
        setActiveButton(""); // Restablecer el botón activo al cerrar el dropdown de modelos
      }
      if (concesionariosDropdownRef.current && !concesionariosDropdownRef.current.contains(event.target)) {
      ...
      <div
        ...
        <div className="hidden md:flex gap-10">
          ...
          <div className="static relative">
            ...
            {showConcesionariosDropdown && (
              <div className="relative top-full left-0 w-full" ref={concesionariosDropdownRef}>
